...
class _ProductListScreenState extends State<ProductListScreen> {
  ...
  int _page = 1;
  int _lastPage = 1;
  final List<ProductListItem> _items = <ProductListItem>[];
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            ...
                            subtitle: item.ratingAvg == null ? null : Text('⭐ ${item.ratingAvg!.toStringAsFixed(1)}'),
                            trailing: Text(
  ...
  Widget build(BuildContext context) {
    ...
    if (imageUrl == null || imageUrl.isEmpty) {
      return const CircleAvatar(
        ...
        child: Icon(Icons.inventory_2_outlined, color: Color(0xFF9CA3AF)),
      );
    }
