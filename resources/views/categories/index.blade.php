...
{{-- Directory links --}}
<div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10" data-animate>
    <a href="{{ route('categories.stores') }}"
        class="flex items-center gap-4 p-5 bg-gradient-to-r from-brand-50 to-brand-100 rounded-2xl border border-brand-200 hover:shadow-soft transition-all duration-300 group">
        <div class="w-14 h-14 bg-brand-500 rounded-xl flex items-center justify-center shrink-0">
        ...
        <div>
            <h3 class="font-bold text-surface-900 group-hover:text-brand-600 transition-colors">Stores Directory</h3>
            <p class="text-sm text-surface-500">80+ local store categories with images</p>
        </div>
        <svg class="w-5 h-5 text-surface-400 ml-auto group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
        </svg>
    </a>
    <a href="{{ route('categories.services') }}"
        class="flex items-center gap-4 p-5 bg-gradient-to-r from-blue-50 to-blue-100 rounded-2xl border border-blue-200 hover:shadow-soft transition-all duration-300 group">
        <div class="w-14 h-14 bg-blue-500 rounded-xl flex items-center justify-center shrink-0">
            <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" d="M11.42 15.17l-5.1-5.1m0 0a7.002 7.002 0 019.9 0m-9.9 0a7.002 7.002 0 000 9.9m9.9-9.9a7.002 7.002 0 010 9.9" />
            </svg>
        </div>
        <div>
            <h3 class="font-bold text-surface-900 group-hover:text-blue-600 transition-colors">Services Directory</h3>
            <p class="text-sm text-surface-500">140+ local service categories with images</p>
        </div>
        <svg class="w-5 h-5 text-surface-400 ml-auto group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
        </svg>
