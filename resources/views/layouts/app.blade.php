                ...
                <div class="flex items-center gap-2 sm:gap-3 ml-auto">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.outside="open = false" x-cloak
                            ...
                            <a href="{{ route('account.settings.index') }}" class="flex items-center gap-3 px-4 py-2 text-surface-600 hover:bg-surface-50 hover:text-surface-900 transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                                ...
                                Settings</a>
                            <a href="{{ route('account.support.index') }}" class="flex items-center gap-3 px-4 py-2 text-surface-600 hover:bg-surface-50 hover:text-surface-900 transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
