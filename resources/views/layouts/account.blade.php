...
<div class="grid md:grid-cols-4 gap-6 lg:gap-8">
    ...
    <aside class="md:col-span-1">
        <div class="card p-5 sticky top-24">
            ...
            'title' => 'Account',
            'links' => [
            ['route' => 'account.settings.index', 'label' => 'Settings', 'svg' => '
            ...
            <path stroke-linecap="round" stroke-linejoin="round" d="M8.625 9.75a3.375 3.375 0 116.75 0c0 1.256-.69 2.35-1.712 2.926a2.25 2.25 0 00-1.163 1.949v.375M12 18.75h.008v.008H12v-.008z" /><path stroke-linecap="round" stroke-linejoin="round" d="M21.75 12a9.75 9.75 0 11-19.5 0 9.75 9.75 0 0119.5 0z" />'],
